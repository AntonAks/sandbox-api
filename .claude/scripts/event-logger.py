#!/usr/bin/env python3
"""Event Logger — appends Claude Code hook events to ~/.claude/hooks-logs/YYYY-MM-DD.jsonl.

Source: https://github.com/karanb192/claude-code-hooks/blob/main/hook-scripts/utils/event-logger.py
"""
...
def get_log_file_path():
    log_dir = Path(__file__).resolve().parent.parent / "hooks-logs"
